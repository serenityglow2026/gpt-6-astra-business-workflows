# Prospect Research Brief Workflow

Create a concise B2B account brief from public information without inventing private facts.
...
Prepare: prospect, your offer and research scope.

## Workflow

1. Review official information.
2. Find relevant recent developments.
3. Identify observable signals.
4. Avoid private inferences.
5. Create evidence-based conversation starters..
