...
Convert meeting notes into a factual follow-up package and clear next actions.
...
Prepare: meeting notes, account context and desired format.

## Workflow

1. Extract goals and objections.
2. Record commitments.
3. Create evidence-based actions.
4. Draft follow-up.
