...
Review a landing page for clarity, intent alignment and conversion friction.
...
Prepare: page URL or copy, traffic source, audience and conversion goal.

## Workflow

1. Review as a first-time visitor.
2. Check hierarchy.
3. Compare with traffic intent.
4. Identify friction.
5. Prioritize tests..
