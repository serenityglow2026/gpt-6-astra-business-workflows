# Campaign Research and Brief Workflow

Build an evidence-informed campaign brief from an offer and audience.
...
Prepare: offer, audience, objective and approved sources.

## Workflow

1. Clarify the conversion goal.
2. Research market language.
3. Develop distinct angles.
4. Flag claims needing evidence.
5. Create an execution brief..
