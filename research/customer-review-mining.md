# Customer Review Mining Workflow

Turn approved customer feedback into structured product and marketing insights.
...
Prepare: review sources, product context and research question.

## Workflow

1. Collect approved feedback.
2. Classify themes.
3. Preserve representative language.
4. Distinguish frequency from importance.
