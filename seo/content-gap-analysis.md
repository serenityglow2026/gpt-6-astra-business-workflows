...
Find missing topics and refresh opportunities without creating keyword cannibalization.
...
Prepare: content inventory, competitor resources and business priorities.

## Workflow

1. Map existing coverage.
2. Compare competitors.
3. Find missing subtopics.
4. Separate new pages from refreshes.
