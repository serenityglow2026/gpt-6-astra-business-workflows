# SERP Opportunity Research Workflow

Evaluate whether a search query presents a realistic content opportunity.
...
Prepare: query, business objective and target market.

## Workflow

1. Identify intent.
2. Inspect ranking page types.
3. Find weak or outdated coverage.
4. Map long tails.
5. Recommend an asset only when it can add distinct value..
