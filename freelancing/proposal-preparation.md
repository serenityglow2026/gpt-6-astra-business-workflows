...
Turn discovery notes into a scoped proposal while keeping assumptions visible.
...
Prepare: discovery notes, proposal template and confirmed requirements.

## Workflow

1. Extract objectives.
2. Define scope.
3. List exclusions and dependencies.
4. Flag unknowns.
