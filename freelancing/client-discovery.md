...
Prepare for a freelance or consulting discovery call using public information.
...
Prepare: client website, your service and known project context.

## Workflow

1. Review public information.
2. Identify visible issues.
3. Separate observations from assumptions.
4. Prepare questions.
5. Create a call agenda..
